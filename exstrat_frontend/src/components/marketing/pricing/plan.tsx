...
export function Plan({ action, currency, description, id, features, name, price, popular }: PlanProps): React.JSX.Element {
	return (
		<Card
			sx={{
				display: "flex",
				...
				height: "100%",
				...(popular && { border: "2px solid var(--mui-palette-primary-main)" }),
			}}
		>
