...
const faqs = [
	...
	{
		id: "FAQ-4",
		question: "How many projects can I build with ExStrat PRO?",
		answer:
	...
	{
		id: "FAQ-3",
		question: "Can I charge users for using my product?",
		answer:
	...
	},
	{
		...
		answer:
			"The Standard license is designed for internal applications in which staff will access the application. An example could be the back-office dashboard of a public-facing crypto trading website in which staff would sign in and manage strategies, wallets, etc.",
	},
