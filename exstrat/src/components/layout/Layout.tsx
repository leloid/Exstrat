...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const noNavPages = ['/onboarding', '/landing', '/login', '/dashboard', '/portfolio', '/transactions', '/strategies', '/strategies/create', '/config', '/prevision', '/investissements', '/settings', '/configuration'];
