...
import { PortfolioSummary } from '@/types/transactions';
import { transactionsApi } from '@/lib/transactions-api';

interface PortfolioViewFixedProps {
  refreshKey?: number;
}

export const PortfolioViewFixed: React.FC<PortfolioViewFixedProps> = ({ refreshKey = 0 }) => {
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            <div className="h-12 w-12 bg-gray-400 rounded-full mx-auto mb-4 flex items-center justify-center">
  ...
  const totalValue = portfolio.positions.reduce((sum, position) => sum + position.totalInvested, 0);
  const totalQuantity = portfolio.positions.reduce((sum, position) => sum + position.totalQuantity, 0);
