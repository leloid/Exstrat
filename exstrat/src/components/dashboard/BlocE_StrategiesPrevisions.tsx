    ...
    <div className={`rounded-2xl p-6 shadow-lg ${isDarkMode ? 'bg-gray-800/95 backdrop-blur-sm border border-gray-700/50' : 'bg-white border border-gray-200/80 shadow-sm'}`}>
      ...
      {selectedForecast && (
        <>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 p-5 rounded-xl ${
            isDarkMode ? 'bg-gradient-to-br from-gray-700/50 to-gray-800/50 border border-gray-600/30' : 'bg-gradient-to-br from-gray-50 to-white border border-gray-200/60 shadow-sm'
          }`}>
            <div>
          ...
          {selectedToken && (
            <div className={`mt-6 p-6 rounded-xl shadow-md ${isDarkMode ? 'bg-gradient-to-br from-gray-700/50 to-gray-800/50 border border-gray-600/30' : 'bg-gradient-to-br from-gray-50 to-white border border-gray-200/60 shadow-sm'}`}>
