...
export class AuthService {
  ...
  async signIn(signInDto: SignInDto): Promise<AuthResponseDto> {
    ...
    if (!user.emailVerified) {
      // Ne pas renvoyer automatiquement l'email ici pour éviter les doubles envois
      // L'utilisateur peut utiliser le bouton "Resend verification email" dans l'interface
